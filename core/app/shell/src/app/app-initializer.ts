      ...
      this.systemConfigStore.load().subscribe(() => {
        ...
        this.extensionLoader
          ...
          .subscribe(() => {
            ...
            const configRoutes =
              this.systemConfigStore.getConfigValue("module_routing");
            ...
            Object.keys(configRoutes).forEach((routeName) => {
              ...
              if (
                !isFalse(configRoutes[routeName].create) &&
                !isFalse(configRoutes[routeName].record)
              ) {
                routes.push({
              ...
              // if (configRoutes[routeName].board) {
              routes.push({
                path: routeName + "/boards",
